    ...
    <section id="about" className="py-24 md:py-32 bg-cream-dark">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="space-y-6 text-ink/80 leading-relaxed text-lg">
          <p>
            Taijiquan (太極拳) is an ancient Chinese internal martial art, rooted in Daoist philosophy 
            and the principles of Yin and Yang. More than a fighting system, it is a path of 
            self-cultivation—a practice that harmonizes body, energy (Qi), and mind.
          </p>
          
          <p>
            The Yang style, known for its graceful, flowing movements, makes this profound art 
            accessible to practitioners of all ages. Through patient practice, we develop 
          ...
          <p className="text-ink/60 italic">
            ...
            under the guidance of Master Liang Dehua, whose teachings trace directly back through 
            Grandmaster Gu Lisheng&apos;s lineage.
          </p>
        </div>
