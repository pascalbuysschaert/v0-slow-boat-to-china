      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center max-w-2xl mx-auto">
          <p className="text-cream/80 leading-relaxed text-lg">
            Everyone is welcome—beginners starting their journey and experienced practitioners 
            deepening their art. What matters is sincerity in practice and openness to learn.
          </p>
